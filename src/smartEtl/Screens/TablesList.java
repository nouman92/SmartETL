...
public class TablesList extends javax.swing.JInternalFrame {
    ...
    public TablesList(Connection conn , String dataFor) {
    	...
    	this.conn = conn;
    	String srcDataBase = ConfigurationService.getAttribute(PropertiesName.getProperty(dataFor+"DB"));
    ...
    private Object[][] LoadData(){
    	...
    	ArrayList<String> tables = DataBaseModule.getTables(conn);
    ...
    public void getTableData(String table){
    	ShowTableData tables = new ShowTableData();
